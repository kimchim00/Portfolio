...
const projects = [
  ...
  },
  {
    ...
    description:
      "An e-commerce website for household items with product browsing and shopping cart features.",
    image: "/project/home.jpg",
    tags: ["React", "TailwindCSS"],
    githubUrl: "https://github.com/kimchim00/Home-Goods-Store",
  },
  {
    id: 3,
    title: "Weather App",
    ...
    tags: ["React", "TailwindCSS","API","Shadcn"],
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, key) => (
            <div
              key={key}
              className="group bg-card rounded-lg overflow-hidden shadow-xs card-hover border transition-colors"
            >
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            href="https://github.com/kimchim00"
          >
